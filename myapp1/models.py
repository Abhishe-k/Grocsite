...
class Client(User):
    ...
    def __str__(self):
        return "username: {0}, Address: {1}, City: {2}".format(self.username, self.shipping_address, self.city)
...
class OrderItem(models.Model):
    ...
    def __str__(self):
        return "username: {0}, Item: {1}, Qty: {2}, Status: {3}".format(self.client.username, self.item, self.qty_ordered, self.status)
